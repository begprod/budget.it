  ...
  <BaseLayout>
    ...
    <div class="mb-10">
      ...
      <div class="grid grid-cols-12 mt-5">
        ...
        />
        <BaseButton class="col-span-2 border-l-0 rounded-l-none" @click="saveNewCurrency(newCurrency)">
          <template #text>
    ...
    <div class="grid grid-cols-12">
      <BaseInput
        ...
        class="col-span-10 rounded-r-none"
      />
      <BaseButton class="col-span-2 border-l-0 rounded-l-none" @click="setDailyBudget(dailyBudgetValue)">
        <template #text>
